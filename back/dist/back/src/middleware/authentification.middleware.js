...
exports.checkLawyer = exports.checkUser = exports.auth = void 0;
var jwt = __importStar(require("jsonwebtoken"));
var fs_1 = __importDefault(require("fs"));
var path_1 = __importDefault(require("path"));
var user_model_1 = require("../model/user.model");
var lawyer_model_1 = require("./../model/lawyer.model");
var cert = fs_1.default.readFileSync(path_1.default.join(__dirname, '../../', 'public.key'));
...
exports.checkUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
...
exports.checkLawyer = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userID, user, error;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
